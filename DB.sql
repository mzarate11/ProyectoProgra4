...
[ID_TIPO_IDENTIFICACION]  int NOT NULL,
CONSTRAINT [PK_NO_CEDULA] PRIMARY KEY CLUSTERED
(
	NO_CEDULA
)
)
...
ADD CONSTRAINT [FK_NO_CEDULA]
	FOREIGN KEY (NO_CEDULA)
...
FROM	[ADMINISTRATIVO].[Persona]
WHERE NO_CEDULA like '%' + @NO_CEDULA + '%'
END
GO
...
WHERE ([NO_CEDULA] = @Num_Cedula and
[NOMBRE] = @Nombre and 
...
AS BEGIN
INSERT INTO [ADMINISTRATIVO].[USUARIO] ([NO_CEDULA],[NOMBRE],[CONTRASEÑA],[ROL])

VALUES (@NO_CEDULA,@NOMBRE,@CONTRASEÑA,@ROL)
