...
namespace BLL.BLL_ADMIN
{
    ...
    {
        public void Crear_tabla(ref cls_Canton_DAL Obj_DAL)
        {
        ...
        public void Listar_Canton(ref cls_Canton_DAL Obj_DAL, string sMsjError)
        {
        ...
        public void Insertar_Canton(ref cls_Canton_DAL Obj_DAL, string sValor1, string sValor2, string sValor3, ref string sMsjError)
        {
            Svc_DataBase.I_DBClient ObjSVC = new Svc_DataBase.I_DBClient();
            Crear_tabla(ref Obj_DAL);
            Obj_DAL.dtParametros.Rows.Add("ID_CANTON", 1, sValor1); //el número corresponde al valor dentro del switch creado en el wfc -
            ...
            Obj_DAL.dtParametros.Rows.Add("ID_PROVINCIA", 1, sValor3);
            Obj_DAL.sNombre_sp = ConfigurationManager.AppSettings["Insert_Cantones"].ToString();// aqui se lee el stored procedure siempre desde el web config y el nombre del key
        ...
        public void Delete_Canton(ref cls_Canton_DAL Obj_DAL, string sValor, ref string sMsjError)
        {
            Svc_DataBase.I_DBClient ObjSVC = new Svc_DataBase.I_DBClient();
            Crear_tabla(ref Obj_DAL);
