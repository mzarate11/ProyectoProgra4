<%@ Page Title="" Language="C#" MasterPageFile="~/Poliza.Master" AutoEventWireup="true" CodeBehind="Beneficiario.aspx.cs" Inherits="PolizaUI.Paginas.Administrativo.Beneficiario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br>
    <br>
    <div id="beneficiario" style="text-align: match-parent" runat="server">
        <label>Filtro:
        ...
        <asp:GridView OnSelectedIndexChanged="GV_beneficiario_SelectedIndexChanged" CssClass="table table-bordered" ID="GV_beneficiario" runat="server">
