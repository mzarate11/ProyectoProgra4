...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br>
    <br>
    <div id="planes" style="text-align: match-parent" runat="server">
        <label>Filtro:
        ...
        <asp:GridView OnSelectedIndexChanged="GV_planes_SelectedIndexChanged" CssClass="table table-bordered" ID="GV_planes" runat="server">
